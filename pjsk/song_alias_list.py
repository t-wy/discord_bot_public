...
song_alias_list: Dict[int, List[str]] = {
    ...
    122: [ # ポジティブ☆ダンスタイム
        ...
        'パピプペポジティブ☆ダンスタイム',
        'Papipupepo',
        'pdt', # Positive Dance Time (separating dance and time)
    ],
    123: [ # どりーみんチュチュ
        '啾啾',
    ],
    ...
    185: [ # しっくおぶはうす！
        ...
        '病家',
        'Soh',
        'soh', # notice みかぼし (star of heaven)
        '餅屋',
    ],
    186: [ # 初音天地開闢神話
        '開天闢地',
    ...
    624: [ # チルノのパーフェクトさんすう学園
        ...
        '⑨',
        '琪露諾的完美算術學園',
        "Cirno's Perfect Math Academy", # https://www.youtube.com/watch?v=JDpkvycpqaQ
    ],
    ...
    721: [ # あいしていたのに
        '愛していたのに',
        '曾經深愛著的', # https://home.gamer.com.tw/artwork.php?sn=5764001
        '明明曾愛著你',
        '曾經深愛著你',
    ],
    722: [ # ダイダイダイダイダイキライ
