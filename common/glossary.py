...
class CardGlossary:
    ...
    using_items_to_unlock_levels = _(
       "Using Items to Unlock Levels",
        ja      = "アイテムを使用して上限解放",
        zh      = "使用物品解放上限"
    )
...
class CharacterGlossary:
    ...
    birthplace = _(
       "Birthplace",
        ...
        ko      = "출신지",
        ko_Kore = "出生地"
    ) # Notice the meaning between 出生地 (place of birth) vs 出身地 (hometown) in Japanese
    blood_type = _(
       "Blood Type",
        ja      = "血液型",
        zh      = "血型",
    ...
    dob = _(
       "DOB",
        ...
        ko      = "생일",
        ko_Kore = "生日"
    ) # differ from "birthday"
    favorite_food = _(
       "Favorite Food", en_GB   = "Favourite Food",
        ja      = "好きな食べ物",
        zh_TW   = "喜歡的食物",
        zh      = "喜欢的食物",
        ko      = "좋아하는 음식"
    ...
    least_favorite_food = _(
       "Least Favorite Food", en_GB   = "Least Favourite Food",
        ja      = "嫌いな食べ物",
        zh_TW   = "討厭的食物",
        zh_CN   = "讨厌的食物",
        ko      = "싫어하는 음식"
...
class EventGlossary:
    ...
    distribution_of_ranking_rewards = _(
       "Distribution of Ranking Rewards",
        ja      = "報酬配布期間",
        zh_TW   = "報酬發送時間",
        zh_CN   = "报酬发送时间",
        ko      = "보상 지급 기간"
...
class WDSGlossary:
    ...
    sense_activation_timing = _(
       "Sense Activation Timing",
        ja      = "センス発動タイミング",
        zh_TW   = "Sense 發動時間",
        zh_CN   = "Sense 发动时间"
    )
