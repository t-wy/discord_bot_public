...
timing_translator = regex_lookup_translator_wrapper("timing_translator", {
    ...
    "センス発動直後、": {
        "en": "Immediately after Sense activates, ",
        "zh_TW": "Sense 發動後當刻，",
        "zh_CN": "Sense 發動后当刻，",
    ...
    "スターアクト発動直後、": {
        "en": "Immediately After Star Act activates, ",
...
trophy_description_translator = regex_lookup_translator_wrapper("trophy_description_translator", {
    ...
    "物語の舞台・浅草を巡るデジタルスタンプラリーに参加しよう": {
        "en": "Participate in the Digital Rally of visiting the Stage of the Story, Asakusa",
    ...
    r"イベント「(.+)」で(?P<actor>.+)応援ランキングの(\d+)位以内に入賞": {
        "en": "Rank among the top {2} in the support ranking of {actor} in the event \"{0}\"",
    ...
    r"公演を(\d+)回クリアしよう": {
        "en": "Clear {0} Performances",
        "zh": "完成 {0} 次公演",
    },
    r"ライフ(\d+)以上で公演をクリアしよう": {
        "en": "Clear a Performance with at least {0} Life",
        "zh": "以 {0} 以上的生命值完成公演",
    },
    r"累計で(\d+)日以上ログインしよう": {
...
single_star_act_translator = regex_lookup_translator_wrapper("single_star_act_translator", {
    "総演技力の[:score]倍のスコアを獲得": {
        ...
        "ko"     : "총 연기력의 [:score]배 스코어 획득",
        "ko_Kore": "總 演技力의 [:score]倍 스코어 獲得",
    },
    ...
    "ライフが多いほどスコア獲得量UP効果（最大＋[:pre1]%）": {
        ...
        "ko"     : "라이프가 많을수록 스코어 획득량 UP (최대 +[:pre1]%)",
    ...
    r"(?P<timing>スターアクト発動時、)編成されている(?P<company>.+)アクターの人数×\[:param11\]秒、センスのCTを短縮する": {
        ...
        "ko"     : "{timing}편성되어 있는 {company} 액터의 인원수 ×[:param11]초, 센스의 CT를 단축",
        "ko_Kore": "{timing}編成되어 있는 {company} 액터의 人員數 ×[:param11]秒, 센스의 CT를 短縮",
    },
    ...
    r"ライフが多いほどスコア獲得量UP効果（最大＋ (\d+)%）": {
        ...
        "ko"     : "라이프가 많을수록 스코어 획득량 UP (최대 +{0}%)",
        "ko_Kore": "라이프가 많을수록 스코어 獲得量 UP (最大 +{0}%)",
    },
    r"付与されているライフガード1回につきスコア獲得量(\d+)％上昇（最大＋(\d+)％）": {
        ...
        "ko"     : "추가되어 있는 라이프 가드 1개당 스코어 획득량 {0}% 상승 (최대 {1}%)",
        "ko_Kore": "追加되어 있는 라이프 가드 1個當 스코어 獲得量 {0}% 上昇 (最大 {1}%)",
    },
    ...
    r"プリンシパルゲージの上限を編成されている(?P<company>.+)アクターの人数×\[:param11\]上昇させる": {
        ...
        "ko"     : "프린시펄 게이지 상한을 편성되어 있는 {company} 액터의 인원수 ×[:param11] 상승",
        "ko_Kore": "프린시펄 게이지 上限을 編成되어 있는 {company} 액터의 人員數 ×[:param11] 上昇",
    },
    ...
    r"付与されているライフガードが(\d+)回以下の時スコア獲得量が(\d+)％上昇、スターアクト発動後、プリンシパルゲージの上限値が(\d+)上昇": {
        "en": "When there are {0} or fewer Life Guard attached, score gain increases by {1}%; After the Star Act activates, increase Principal Gauge Cap by {2}",
...
single_sense_translator = regex_lookup_translator_wrapper("single_sense_translator", {
    ...
    "[:gauge]のプリンシパルゲージを獲得": {
        ...
        "ko"     : "[:gauge] 프린시펄 게이지 획득",
        "ko_Kore": "[:gauge] 프린시펄 게이지 獲得",
    },
    "ライフを[:param11]回復": {
    ...
    r"(?P<timing>センス発動時、)(?P<company>.+)アクターの人数×(\d+)のプリンシパルゲージを獲得": {
        ...
        "ko"     : "{timing}{company} 액터의 인원수 ×{2} 프린시펄 게이지 획득",
        "ko_Kore": "{timing}{company} 액터의 人員數 ×{2} 프린시펄 게이지 獲得",
    },
    r"(?P<timing>センス発動時、)編成されている(?P<company>.+)アクターの人数×(\d+)プリンシパルゲージを獲得": {
        ...
        "ko"     : "{timing}편성되어 있는 {company} 액터의 인원수 ×{2} 프린시펄 게이지 획득",
        "ko_Kore": "{timing}編成되어 있는 {company} 액터의 人員數 ×{2} 프린시펄 게이지 獲得",
    },
    ...
    r"(?P<timing>センス発動時、)追加で「ライフガード」を獲得する（レベル1：(\d+)個／レベル2：(\d+)個／レベル3：(\d+)個／レベル4：(\d+)個／レベル5：(\d+)個\)": {
        ...
        "ko"     : "{timing}추가로 ‘라이프 가드’ 획득한다 (Lv.1: {1}개／Lv.2: {2}개／Lv.3: {3}개／Lv.4: {4}개／Lv.5: {5}개)",
        "ko_Kore": "{timing}追加로 ‘라이프 가드’ 獲得한다 (Lv.1: {1}個／Lv.2: {2}個／Lv.3: {3}個／Lv.4: {4}個／Lv.5: {5}個)",
    },
    ...
    r"(?P<timing>センス発動[時後]、)付与されているライフガード1回につきプリンシパルゲージの上限値が(\d+)上昇（最大\+(\d+)）": {
        ...
        "ko"     : "{timing}추가되어 있는 라이프 가드 1개당 {1} 프린시펄 게이지 상한 상승 (최대 +{2})",
    ...
    r"(?P<timing>センス発動直後、)自身の(?P<status>.+?)の\[:param1(\d+)\]倍のスコアを獲得": {
        ...
        "ko"     : "{timing}자신의 {status}의 [:param1{2}]배 스코어 획득",
        "ko_Kore": "{timing}自身의 {status}의 [:param1{2}]倍 스코어 獲得",
    },
    ...
    r"ライフが多いほど(?P<actor>.+)のスコア獲得量UP(?:効果)?（最大＋(\d+)％）": {
        ...
        "ko"     : "라이프가 많을수록 {actor}의 스코어 획득량 UP (최대 +{1}%)",
        "ko_Kore": "라이프가 많을수록 {actor}의 스코어 獲得量 UP (最大 +{1}%)",
    },
    r"ライフが少ないほど(?P<actor>.+)のスコア獲得量UP（最大＋(\d+)％）": { # not in use
        ...
        "ko"     : "라이프가 작을수록 {actor}의 스코어 획득량 UP (최대 +{1}%)",
        "ko_Kore": "라이프가 작을수록 {actor}의 스코어 獲得量 UP (最大 +{1}%)",
    },
    r"\[:sec(\d*)\]秒間、(?P<company>.+)のアクターに(?P<sense_star_act>センス|スターアクト)スコア\[:param(\d\d)\]％UP効果": {
        ...
        "ko"     : "[:sec{0}]초간, {company}의 액터에게 {sense_star_act} 스코어 [:param{3}]% UP",
        "ko_Kore": "[:sec{0}]秒間, {company}의 액터에게 {sense_star_act} 스코어 [:param{3}]% UP",
    },
    r"\[:sec(\d*)\]秒間、編成されているアクターのプリンシパルゲージ獲得量\[:param(\d\d)\]％UP効果": {
        ...
        "ko"     : "[:sec{0}]초간, 편성되어 있는 액터의 프린시펄 게이지 획득량 [:param{1}]% UP",
        "ko_Kore": "[:sec{0}]秒間, 編成되어 있는 액터의 프린시펄 게이지 獲得量 [:param{1}]% UP",
    },
    ...
    r"(?P<company>.+)または(?P<company2>.+)アクターの編成数×\[:param11\]プリンシパルゲージの上限が上昇する": {
        ...
        "ko"     : "편성되어 있는 {company} 또는 {company2} 액터의 인원수 ×[:param11] 프린시펄 게이지 상한 상승",
        "ko_Kore": "編成되어 있는 {company} 또는 {company2} 액터의 人員數 ×[:param11] 프린시펄 게이지 上限 上昇",
    },
    r"編成されている属性1種類につきスコア獲得量(\d+)％上昇（最大＋(\d+)％）": {
        "en": "For each attribute there is in the Unit, score gain increases by {0}% (+{1}% at most)",
        "zh_TW": "每 1 個編成的屬性能使分數獲得量增加 {0}%（最多 +{1}%）",
    ...
    r"編成されている(?P<company>.+)アクターの人数×(\d+)プリンシパルゲージを獲得": {
        ...
        "ko"     : "편성되어 있는 {company} 액터의 인원수 ×{1} 프린시펄 게이지 획득",
        "ko_Kore": "編成되어 있는 {company} 액터의 人員數 ×{1} 프린시펄 게이지 獲得",
    },
...
single_leader_sense_translator = regex_lookup_translator_wrapper("single_leader_sense_translator", {}, {
    r"「(.+?)」カテゴリの(?P<status>.+?)(\d+)[%％]上昇・(?P<status2>.+?)(が?)(\d+)[%％]上昇": {
        ...
        "ko"     : "‘{0}’ 카테고리의 {status} {2}% 상승・{status2} {5}% 상승",
        "ko_Kore": "‘{0}’ 카테고리의 {status} {2}% 上昇・{status2} {5}% 上昇",
    },
    r"「(.+?)」カテゴリの(?P<status>.+?)(\d+)[%％]上昇・初期ライフ(が?)(\d+)上昇": {
        ...
        "ko"     : "‘{0}’ 카테고리의 {status} {2}% 상승・초기 라이프 {4}% 상승",
        "ko_Kore": "‘{0}’ 카테고리의 {status} {2}% 上昇・初期 라이프 {4}% 上昇",
    },
    ...
    r"「(.+?)」カテゴリのCTを(\d+)秒短縮する": {
        ...
        "ko"     : "‘{0}’ 카테고리의 CT {1}초 단축",
        "ko_Kore": "‘{0}’ 카테고리의 CT {1}秒 短縮",
    }
})
...
bloom_translator = regex_lookup_translator_wrapper("bloom_translator", {}, {
    ...
    r"(?P<timing>公演開始時に)(?P<sense_type>.{2})の光を獲得": {
        ...
        "ko"     : "{timing}{sense_type}의 빛({sense_emoji}) 획득",
        "ko_Kore": "{timing}{sense_type}의 빛({sense_emoji}) 獲得",
    },
    r"(?P<timing>公演開始時に)自身と同系統の光を獲得": {
        ...
        "ko"     : "{timing}자신과 같은 색의 빛 획득",
        "ko_Kore": "{timing}自身과 같은 色의 빛 獲得",
    },
    r"演技力(\d+)[%％]UP": {
        "en": "Status {}% UP",
        "zh": "演技力 {}% UP",
    ...
    r"センスのCTが(\d+)秒減少": {
        "en": "Sense CT reduces by {}s",
        "zh_TW": "Sense 的 CT 減少{}秒",
        "zh_CN": "Sense 的 CT 减少{}秒",
        "th": "CT ลดลง {} วินาที",
        "ko"     : "센스의 CT {}초 단축",
        "ko_Kore": "센스의 CT {}秒 短縮",
    },
    r"基礎スコアが(\d+)％上昇": {
        "en": "Base score increases by {}%",
        "zh_TW": "基礎分數提升 {}%",
        "zh_CN": "基础分数提升 {}%",
    ...
    r"スターアクト発動に必要な(?P<sense_type>.{2})の光の個数が(\d+)個減少": {
        ...
        "en": "Number of {sense_type} Lights ({sense_emoji}) required to trigger Star Act reduces by {1}",
    ...
    r"(?P<sense_type>.{2})の光追加": {
        ...
        "ko"     : "{sense_type}의 빛({sense_emoji}) 추가",
        "ko_Kore": "{sense_type}의 빛({sense_emoji}) 追加",
    },
})
...
condition_translator = regex_lookup_translator_wrapper("condition_translator", {}, {
    ...
    r"(?P<actor>.+)が装備かつ(?P<company>.+)に所属しているアクターのみで編成": {
    ...
    r"(?P<actor>.+)が装備かつ(?P<company>.+)に所属しているアクターを(\d+)人以上編成": {
        "en": "Equipped by {actor}, and the Unit consists of {2} or more {company} Actors",
        "zh_TW": "由{actor}裝備且隊伍由至少 {2} 名{company}所屬演員組成",
...
poster_ability_translator = regex_lookup_translator_wrapper("poster_ability_translator", {
    ...
    r"(?P<company>.+)に所属するアクターの(?P<status>.+?)が\[:param11\][%％]上昇": {
        "en": "{status} of {company} Actors increase by [:param11]%",
    ...
    r"全アクターの(?P<status>.+?)が\[:param11\][%％]上昇": {
        ...
        "zh_TW": "全部演員的{status}提升[:param11]%",
        "zh_CN": "全部演员的{status}提升[:param11]%",
        "th": "ความสามารถ{status}ทุกคนเพิ่มขึ้น [:param11] %",
    },
    r"自身のセンスのCT[がを]\[:param11\]秒短縮": {
        "en": "CT of one's Sense reduces by [:param11]s",
    ...
    r"自身の(?P<status>.+?)が\[:param11\][%％]上昇": {
        "en": "One's {status} increases by [:param11]%",
    ...
    r"編成されている属性数が多いほど自身の(?P<status>.+?)が上昇（4属性：\[:param11\][%％]／3属性：\[:param21\][%％]／2属性：\[:param31\][%％]／1属性：\[:param41\][%％]）": {
        "en": "The more attributes there are in the Unit, the more one's {status} increases (4 attributes: [:param11]% / 3 attributes: [:param21]% / 2 attributes: [:param31]% / 1 attribute: [:param41]%)",
    ...
    r"編成されている属性数が少ないほど自身の(?P<status>.+?)が上昇（1属性：\[:param11\][%％]／2属性：\[:param21\][%％]／3属性：\[:param31\][%％]／4属性：\[:param41\][%％]）　*": {
        "en": "The fewer attributes there are in the Unit, the more one's {status} increases (1 attribute: [:param11]% / 2 attributes: [:param21]% / 3 attributes: [:param31]% / 4 attributes: [:param41]%)",
...
accessory_effect_translator = regex_lookup_translator_wrapper("accessory_effect_translator", {
    ...
    r"自身のセンスのCTが\[:param1\]秒短縮": {
        "en": "CT of one's Sense reduces by [:param1]s",
